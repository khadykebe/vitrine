    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#about">Programmes éducatifs</a></li>
          <li><a href="#features">Actualités et événements</a></li>
          <li><a href="#services">Vie scolaire</a></li>
          <li><a href="#pricing">Informations pratiques</a></li>
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a data-bs-toggle="modal" data-bs-target="#loginModal" class="btn-get-started">Se connecter</a>
              ...
              <div class="swiper-slide">
                <div class="testimonial-item">
                    <div class="gallery-item">
                        ...
                        <img src="assets/img/tabs-1.jpg" class="img-fluid" alt="">
...
<div id="lightbox" class="lightbox">
  ...
  {{-- <div class="video-gallery">
    <div class="video-thumbnail" data-video-url="video1.mp4">
        <video width="800" height="400" controls>
            <source src="assets/img/testimonials/video1.mp4" type="video/mp4">
