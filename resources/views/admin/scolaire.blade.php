...
<body>
              ...
              <table class="table datatable">
                <thead>
                    ...
                    <tbody>
                        <tr>
                            <td>{{ $scolaire->nom }}</td>
                            <td>{{ $scolaire->description }}</td>
                            <td>
                                <button class="btn btn-primary edit-btn"  data-id="{{ $scolaire->id }}" data-nom="{{ $scolaire->nom }}" data-description="{{ $scolaire->description }}"  data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></button>
                                <button class="btn btn-danger delete-btn" data-id="{{ $scolaire->id }}" data-toggle="modal" data-target="#deleteModal"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                        </tbody>
                    @endforeach
      ...
      <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="POST" action="{{ route('addscol') }}">
                    @csrf
 ...
 <!-- Modal de Modification -->
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="editForm" method="POST" action="{{route('updatescol',$scolaire->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
 ...
 <!-- Modal de Suppression -->
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="deleteForm" method="POST" action="{{route('deletescol',$scolaire->id)}}">
                    @csrf
                    @method('DELETE')
                    <div class="modal-header">
...
<script>
           $(document).on('click', '.edit-btn', function() {
            ...
            $('#editForm').attr('action', '/updatescol/' + id);
        });

        // Script pour gérer le formulaire de suppression
        $(document).on('click', '.delete-btn', function() {
            let id = $(this).data('id');
            $('#deleteForm').attr('action', '/deletescol/' + id);
        });
</script>
